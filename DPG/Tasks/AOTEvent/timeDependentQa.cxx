...
const AxisSpec axisDcaR{1000, -1., 1., "DCA_{r}, cm"};
const AxisSpec axisDcaZ{1000, -1., 1., "DCA_{z}, cm"};
...
struct TimeDependentQaTask {
  ...
  enum EvSelBitsToMonitor {
    ...
    enIsLowOccup,
    enIsLowOccupAlsoInPrevRof,
    enIsLowOccupAndCut2000,
    enIsLowOccupAlsoInPrevRofAndCut2000,
    enIsLowOccupAndCut500,
    enIsLowOccupAlsoInPrevRofAndCut500,
    enIsLowOccupAlsoInPrevRofAndCut500noDeadStaves,
  ...
  void process(ColEvSels const& cols, BCsRun3 const& bcs, BarrelTracks const& tracks)
  {
    ...
    if (runNumber != lastRunNumber) {
      ...
      histos.add("hSecondsEventSelBits", "", kTH2F, {axisSeconds, {enNumEvSelBits, -0.5, enNumEvSelBits - 0.5, "Monitoring of event selection bits"}});
      TAxis* axSelBits = (TAxis*)histos.get<TH2>(HIST("hSecondsEventSelBits"))->GetYaxis();
      ...
      axSelBits->SetBinLabel(1 + enIsLowOccup, "isLowOccup");
      axSelBits->SetBinLabel(1 + enIsLowOccupAlsoInPrevRof, "isLowOccupAlsoInPrevRof");
      axSelBits->SetBinLabel(1 + enIsLowOccupAndCut2000, "isLowOccupAndCut2000");
      axSelBits->SetBinLabel(1 + enIsLowOccupAlsoInPrevRofAndCut2000, "isLowOccupAlsoInPrevRofAndCut2000");
      axSelBits->SetBinLabel(1 + enIsLowOccupAndCut500, "isLowOccupAndCut500");
      axSelBits->SetBinLabel(1 + enIsLowOccupAlsoInPrevRofAndCut500, "isLowOccupAlsoInPrevRofAndCut500");
      axSelBits->SetBinLabel(1 + enIsLowOccupAlsoInPrevRofAndCut500noDeadStaves, "isLowOccupAlsoInPrevRofAndCut500noDeadStaves");
    ...
    for (const auto& col : cols) {
      ...
      bool isLowOccup = col.selection_bit(kNoCollInTimeRangeStandard) && col.selection_bit(kNoCollInRofStandard);
      bool isLowOccupAlsoInPrevRof = isLowOccup && col.selection_bit(kNoCollInRofStandard);
      histos.fill(HIST("hSecondsEventSelBits"), secFromSOR, enIsLowOccup, isLowOccup);
      histos.fill(HIST("hSecondsEventSelBits"), secFromSOR, enIsLowOccupAlsoInPrevRof, isLowOccupAlsoInPrevRof);

      bool isLowOccupAndCut2000 = isLowOccup && occupByTracks >= 0 && occupByTracks < 2000;
      bool isLowOccupAlsoInPrevRofAndCut2000 = isLowOccupAlsoInPrevRof && occupByTracks >= 0 && occupByTracks < 2000;
      histos.fill(HIST("hSecondsEventSelBits"), secFromSOR, enIsLowOccupAndCut2000, isLowOccupAndCut2000);
      histos.fill(HIST("hSecondsEventSelBits"), secFromSOR, enIsLowOccupAlsoInPrevRofAndCut2000, isLowOccupAlsoInPrevRofAndCut2000);

      bool isLowOccupAndCut500 = isLowOccup && occupByTracks >= 0 && occupByTracks < 500;
      bool isLowOccupAlsoInPrevRofAndCut500 = isLowOccupAlsoInPrevRof && occupByTracks >= 0 && occupByTracks < 500;
      bool isLowOccupAlsoInPrevRofAndCut500noDeadStaves = isLowOccupAlsoInPrevRofAndCut500 && col.selection_bit(kIsGoodITSLayersAll);
      histos.fill(HIST("hSecondsEventSelBits"), secFromSOR, enIsLowOccupAndCut500, isLowOccupAndCut500);
      histos.fill(HIST("hSecondsEventSelBits"), secFromSOR, enIsLowOccupAlsoInPrevRofAndCut500, isLowOccupAlsoInPrevRofAndCut500);
      histos.fill(HIST("hSecondsEventSelBits"), secFromSOR, enIsLowOccupAlsoInPrevRofAndCut500noDeadStaves, isLowOccupAlsoInPrevRofAndCut500noDeadStaves);
